...
- **Local Testing**: The `air run` command accepts local paths (e.g., `.\skill.yaml`). It will automatically read the local file and execute it. You do _not_ need to publish it first.
