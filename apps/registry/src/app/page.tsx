      ...
      <section className="relative px-6 pt-28 pb-20 md:pt-36 md:pb-28 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            {/* Left: Copy */}
            <div>
              <Badge variant="secondary" className="mb-6 inline-flex items-center gap-1.5 px-3 py-1 text-xs font-medium tracking-wide uppercase bg-blue-500/10 text-blue-400 border-blue-500/20">
              ...
              <div className="flex flex-col sm:flex-row items-start gap-3 mb-10">
                <Button asChild size="lg" className="bg-white text-black hover:bg-neutral-200 h-11 px-7 rounded-full text-sm font-medium">
                  <Link href="/packages">
                    Browse Registry
                    <ArrowRight className="ml-2 h-4 w-4" />
                  </Link>
                </Button>
                <Button asChild size="lg" variant="outline" className="border-white/20 text-white hover:bg-white/10 h-11 px-7 rounded-full text-sm font-medium bg-transparent">
              ...
              <div className="flex gap-10 border-t border-white/10 pt-8">
                <div>
                  ...
                  <div className="text-xs text-neutral-500 mt-1 uppercase tracking-wider">packages</div>
                </div>
                <div>
                  <div className="text-2xl md:text-3xl font-semibold tracking-tight tabular-nums">
                    {stats.usersCount}
                  </div>
                  <div className="text-xs text-neutral-500 mt-1 uppercase tracking-wider">developers</div>
                </div>
                <div>
                  <div className="text-2xl md:text-3xl font-semibold tracking-tight tabular-nums">
                    {stats.downloadsCount.toLocaleString()}
                  </div>
                  <div className="text-xs text-neutral-500 mt-1 uppercase tracking-wider">downloads</div>
                </div>
              </div>
            </div>
...
Installed to ~/.skillspace/registry/`}
      ...
      <section className="px-6 py-20 border-t border-white/5">
        <div className="mx-auto max-w-6xl">
          <div className="flex items-end justify-between mb-14">
            ...
            <Link href="/docs" className="hidden md:flex items-center gap-1.5 text-sm text-neutral-500 hover:text-white transition-colors">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.step} className="group">
                <div className="rounded-xl border border-white/10 bg-white/5 p-6 h-full hover:border-white/20 hover:bg-white/[0.07] transition-all duration-200">
                  <div className="flex items-center gap-3 mb-4">
                    <span className="flex items-center justify-center w-7 h-7 rounded-full bg-blue-500 text-white text-xs font-medium">
                      {item.step}
                    </span>
                    <h3 className="text-sm font-semibold uppercase tracking-wider text-neutral-400">{item.title}</h3>
                  </div>
                  <p className="text-neutral-400 text-sm mb-5 leading-relaxed">
                    {item.desc}
                  </p>
                  <code className="block text-xs font-mono bg-black/50 border border-white/10 rounded-lg px-3 py-2.5 text-neutral-300 group-hover:border-white/20 transition-colors">
      ...
      <section className="px-6 py-16 border-t border-white/5">
        <div className="mx-auto max-w-6xl text-center">
          <p className="text-xs font-medium uppercase tracking-widest text-neutral-500 mb-8">
            Works with every major AI provider
          </p>
          <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-4">
            {['Claude', 'GPT-4o', 'Gemini', 'Ollama', 'Mistral', 'Llama'].map((name) => (
              <span key={name} className="text-lg font-semibold text-neutral-400 hover:text-white transition-colors cursor-default">
                {name}
              </span>
            ))}
          </div>
      ...
      <section className="px-6 py-20 border-t border-white/5">
        <div className="mx-auto max-w-6xl">
          <div className="flex items-end justify-between mb-10">
            ...
            {packages.length > 0 && (
              <Button asChild variant="outline" className="border-white/20 text-white hover:bg-white/10 bg-transparent hidden sm:flex rounded-full text-sm">
          ...
          {packages.length === 0 ? (
            <div className="text-center py-16 border border-dashed border-white/10 rounded-xl">
              ...
              <p className="text-neutral-500 mb-4">No packages published yet.</p>
              <Button asChild size="sm" className="bg-white text-black hover:bg-neutral-200 rounded-full">
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Button asChild className="mt-8 bg-white text-black hover:bg-neutral-200 rounded-full text-sm font-medium">
                <Link href="/docs">
                  Get started
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
            ...
            <div className="bg-neutral-950 rounded-2xl border border-white/10 overflow-hidden">
              <div className="flex items-center gap-2 px-4 py-3 border-b border-white/10">
                <div className="h-3 w-3 rounded-full bg-red-500/80" />
                <div className="h-3 w-3 rounded-full bg-yellow-500/80" />
                <div className="h-3 w-3 rounded-full bg-green-500/80" />
                <span className="ml-3 text-xs font-mono text-neutral-500">terminal</span>
              </div>
              <div className="p-5 font-mono text-sm leading-relaxed">
                <div className="text-neutral-500 mb-1"># Install a skill</div>
                <div className="text-neutral-300 mb-4">
                  <span className="text-blue-400">$</span> skillspace install @skillspace/code-reviewer
                </div>
                <div className="text-neutral-500 mb-1"># Run it against your code</div>
                <div className="text-neutral-300 mb-4">
                  <span className="text-blue-400">$</span> skillspace run code-reviewer --input ./src
                </div>
                <div className="text-neutral-500 mb-1"># Publish your own</div>
                <div className="text-neutral-300 mb-4">
                  <span className="text-blue-400">$</span> skillspace publish
                </div>
                <div className="text-neutral-500 mb-1"># Check what&apos;s installed</div>
                <div className="text-neutral-300">
                  <span className="text-blue-400">$</span> skillspace list
                </div>
      ...
      <section className="px-6 py-20 border-t border-white/5">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="border border-white/10 rounded-xl overflow-hidden">
            <div className="grid grid-cols-4 bg-white/5 border-b border-white/10 text-xs font-medium uppercase tracking-wider text-neutral-500">
            ...
            {[
              ...
              <div key={row.feature} className={`grid grid-cols-4 text-sm ${i < 5 ? 'border-b border-white/5' : ''}`}>
                <div className="px-5 py-3.5 font-medium text-neutral-300">{row.feature}</div>
                <div className="px-5 py-3.5 text-center">
                  {row.skillspace ? (
                    <CheckCircle2 className="h-4 w-4 text-blue-400 mx-auto" />
                  ) : (
      ...
      <section className="px-6 py-24 border-t border-white/5">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
            <Button asChild size="lg" className="bg-white text-black hover:bg-neutral-200 h-12 px-8 rounded-full text-sm font-medium">
              <Link href="/packages">
                Browse Registry
                <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="border-white/20 text-white hover:bg-white/10 h-12 px-8 rounded-full text-sm font-medium bg-transparent">
              <a href="https://github.com/NoticedXAaryan/skillspace" target="_blank" rel="noopener noreferrer">
                View on GitHub
                <ArrowUpRight className="ml-1.5 h-3.5 w-3.5" />
              </a>
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-sm text-neutral-400 font-mono">
