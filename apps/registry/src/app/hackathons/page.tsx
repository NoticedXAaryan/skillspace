              ...
              <CardContent className="p-8 flex flex-col md:flex-row gap-8 relative z-10">
                <div className="flex flex-col flex-1">
                  ...
                  <h3 className="text-3xl font-bold text-white mb-4">
                    The Autonomous Agents Hackathon
                  </h3>
                  <p className="text-neutral-400 mb-8 max-w-lg leading-relaxed">
                    Build a fully autonomous agent using the SkillSpace Runtime that can accomplish
                    a complex multi-step workflow without human intervention.
                  </p>
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                {[
                  {
                    month: 'May 2026',
                    title: 'Data Pipeline Masters',
                    winner: 'data-smith',
                    prize: '$3,000',
                  },
                  {
                    month: 'April 2026',
                    title: 'Generative UI Challenge',
                    winner: 'design-corp',
                    prize: '$2,500',
                  },
                  {
                    month: 'March 2026',
                    title: 'Local Models Hack',
                    winner: 'privacy-first',
                    prize: '$4,000',
                  },
                ].map((past) => (
                  <Card key={past.month} className="bg-neutral-950 border-white/10">
                    <CardContent className="p-6">
                      <div className="text-xs font-mono font-bold text-neutral-500 uppercase tracking-widest mb-2">
                        {past.month}
                      </div>
          ...
          <aside className="flex flex-col gap-6">
            <Card className="bg-neutral-950 border-white/10">
              <CardContent className="p-6">
                  ...
                  {[
                    ...
                    <div key={user.name} className="flex items-center justify-between group">
                      <div className="flex items-center gap-3">
                        <span
                          className={`font-mono font-bold text-sm ${i === 0 ? 'text-amber-500' : i === 1 ? 'text-zinc-400' : i === 2 ? 'text-orange-400' : 'text-neutral-600'}`}
                        >
                          #{i + 1}
                        </span>
                        <span className="text-sm font-medium text-neutral-300 group-hover:text-cyan-400 transition-colors">
                          @{user.name}
                        </span>
                      </div>
                ...
                <Button
                  variant="ghost"
                  className="w-full text-neutral-400 hover:text-white justify-between"
                >
              ...
              <CardContent className="p-6">
                ...
                <div className="flex flex-col gap-4">
                  {[
                    ...
                    <div
                      key={i}
                      className="flex flex-col gap-1 pb-4 border-b border-white/5 last:border-0 last:pb-0"
                    >
