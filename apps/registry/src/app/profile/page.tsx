      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-[300px_1fr]">
        <aside className="flex flex-col gap-6">
          <div className="rounded-xl border border-border bg-card p-6 shadow-sm">
            <h2 className="mb-6 border-b border-border pb-2 text-xl font-bold text-foreground">
              Account Info
            </h2>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1">
                ...
                <span>
                  {profile.verified ? (
                    <Badge className="bg-green-500/10 text-green-500 hover:bg-green-500/20 border-green-500/20 border">
                      Verified
                    </Badge>
                  ) : (
                  ...
                  >
                    <div>
                      ...
                      <div className="text-xs text-muted-foreground">
                        ...
                        <span className="capitalize">{membership.organization.plan}</span> plan
                      </div>
                    </div>
