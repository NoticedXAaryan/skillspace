          ...
          >
            ...
            >
              ...
              <input
                ...
                autoFocus
                className="h-12 flex-1 bg-transparent pr-4 text-sm outline-none placeholder:text-muted-foreground text-foreground"
              />
              <motion.button
                type="button"
                ...
                whileTap={{ scale: 0.9 }}
                className="mr-2 flex h-8 w-8 items-center justify-center rounded-full hover:bg-muted text-muted-foreground"
              >
                <X className="h-4 w-4" />
              </motion.button>
            </motion.div>
