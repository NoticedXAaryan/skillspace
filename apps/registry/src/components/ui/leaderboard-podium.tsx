        ...
        {second && (
          <div className="flex flex-col items-center flex-1 max-w-[120px] animate-in slide-in-from-bottom-8 duration-700">
            <div className="flex flex-col items-center mb-2">
              ...
              <span className="text-xs font-medium text-center mt-3 text-muted-foreground truncate w-full px-1">
                {second.userName}
              </span>
        ...
        {first && (
          <div className="flex flex-col items-center flex-1 max-w-[140px] animate-in slide-in-from-bottom-12 duration-1000">
            <div className="flex flex-col items-center mb-2">
              ...
              <span className="text-sm font-bold text-center mt-3 text-amber-500 truncate w-full px-1">
                {first.userName}
              </span>
