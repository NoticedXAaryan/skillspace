    ...
    <footer className="relative mt-24 border-t border-white/10 bg-black pt-20 pb-12 overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto grid max-w-6xl grid-cols-1 gap-12 sm:grid-cols-2 md:grid-cols-5 px-6">
        <div className="md:col-span-2">
          <Link href="/" className="mb-4 inline-block text-xl font-bold tracking-tight text-white hover:text-blue-400 transition-colors">
            SkillSpace
          </Link>
          <p className="mb-6 text-base text-neutral-400 max-w-xs leading-relaxed">
            The universal runtime and registry for AI capabilities. Build, share, and execute skills anywhere.
          </p>
          <div className="flex gap-4">
            <a href="https://github.com/NoticedXAaryan/skillspace" target="_blank" rel="noopener noreferrer" className="text-neutral-500 hover:text-white transition-colors">
        ...
        <div>
          <h3 className="mb-6 text-sm font-semibold uppercase tracking-wider text-white">Registry</h3>
          <div className="flex flex-col gap-4">
            <Link href="/packages" className="text-sm text-neutral-400 hover:text-white transition-colors">Browse Packages</Link>
            <Link href="/search" className="text-sm text-neutral-400 hover:text-white transition-colors">Search Skills</Link>
            <Link href="/trending" className="text-sm text-neutral-400 hover:text-white transition-colors">Trending</Link>
            <Link href="/analytics" className="text-sm text-neutral-400 hover:text-white transition-colors">Analytics</Link>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link href="/docs/api" className="text-sm text-neutral-400 hover:text-white transition-colors">API Reference</Link>
            <Link href="/playground" className="text-sm text-neutral-400 hover:text-white transition-colors">Playground</Link>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-4">
            <Link href="/terms" className="text-sm text-neutral-400 hover:text-white transition-colors">Terms of Service</Link>
