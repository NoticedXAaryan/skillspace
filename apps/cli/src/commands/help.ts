...
const docs: Record<string, { title: string; desc: string; flags: string[]; examples: string[] }> = {
  ...
  init: {
    ...
    examples: ['$ skillspace init', '$ skillspace init --type agent --name my-jarvis'],
  },
  publish: {
